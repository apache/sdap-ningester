...
@SpringBootTest
@TestPropertySource(properties = {"spring.config.location = classpath:testjobs/AvhrrClimJobTest.yml"})
...
public class AvhrrClimJobTest {
    ...
    public void testJobCompletes() throws Exception {
        ...
        JobParameters jobParameters = new JobParametersBuilder()
                .addString("granule", "classpath:granules/001.L4_5day_avhrr_clim_sst_pixelMean.nc")
                .toJobParameters();
